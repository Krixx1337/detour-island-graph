...
- **Layer-aware graph shaping:** Discovery and pruning preserve clearly separated vertical routes while collapsing nearby sampling noise, keeping stacked 3D worlds connected without exploding graph density.
